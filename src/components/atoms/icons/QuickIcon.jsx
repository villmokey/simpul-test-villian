...
export const QuickIcon = ({ width, height, className, fillColor }) => {
  return (
    <svg width={width} height={height} viewBox="0 0 18 32" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
