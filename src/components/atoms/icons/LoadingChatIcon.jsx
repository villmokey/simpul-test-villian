...
export const LoadingChatIcon = ({ width, height, className, fillColor }) => {
  return (
    <>
      <svg width={width} height={height} className={className} viewBox="0 0 86 86" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
...
LoadingChatIcon.propTypes = {
  width: PropTypes.number,
  height: PropTypes.number,
  fillColor: PropTypes.string,
};

LoadingChatIcon.defaultProps = {
  width: 24,
  height: 24,
  fillColor: "#C4C4C4",
};
